...
$(document).ready(function () {
    $('#form_full').validate({
        ...
        submitHandler: function () {
            formHandler('#form_full', 'request_online.php')
        }
    });
})
...
$(document).ready(function () {
    $('#form_part').validate({
        ...
        submitHandler: function () {
            formHandler('#form_part', 'request_online_without.php')
        }
    });
})
...
$('.form-close-btn').on('click', function () {
    $('body').removeClass('form_done')
})

$('.dark-form').on('click', function () {
    $('body').removeClass('form_done')
})
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const deadline = new Date(2022, 6, 1);
    // id таймера
    let timerId = null;
